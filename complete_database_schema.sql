-- =============================================
-- RJ4WEAR E-COMMERCE COMPLETE DATABASE SCHEMA
-- Comprehensive Supabase PostgreSQL Schema with Migrations
-- Created: December 2024
-- Version: Latest (includes all migrations)
-- =============================================
...
-- =============================================
-- 8. ORDERS TABLE (Updated with Migration 001)
-- =============================================
CREATE TABLE orders (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    ...
    applied_delivery_fee DECIMAL(10,2) DEFAULT 0, -- Delivery fee applied at order time (Migration 001)
...
-- Delivery fee related indexes (Migration 001)
...
-- Function to handle new user profile creation (from supabase-profile-trigger.sql)
...
-- Force RLS for critical tables (Migration 002)
...
-- User Addresses - Users can manage their own addresses (Migration 003)
...
-- =============================================
-- RLS POLICIES - ORDER ACCESS (Migration 002)
-- =============================================

-- Orders - Allow creation for all users, viewing for own orders and guests by email
...
-- Order Items - Allow creation for all users, viewing for accessible orders
...
-- Admin policies for user addresses (Migration 003)
...
-- =============================================
-- SERVICE ROLE PERMISSIONS (Migration 002)
-- =============================================
...
-- Enhanced order summary view (Migration 001)
...
-- Insert Sample Product Images (placeholder URLs - replace with actual image URLs)
...
COMMENT ON COLUMN user_profiles.id IS 'UUID that references auth.users.id from Supabase Auth';
COMMENT ON COLUMN orders.user_id IS 'Foreign key to user_profiles.id - NULL for guest orders';
COMMENT ON TABLE order_summary IS 'Enhanced view providing order analysis including delivery fee calculations';
COMMENT ON TABLE products_with_details IS 'Complete product view with category info, stock levels, and featured images';

-- =============================================
-- COMPLETION MESSAGE
-- =============================================
SELECT 'RJ4WEAR Complete Database Schema Created Successfully! 🎉' as message,
       'Includes: Schema, Migrations, RLS Policies, Functions, Views, Sample Data' as features,
       'Version: Latest with all migrations applied' as version;